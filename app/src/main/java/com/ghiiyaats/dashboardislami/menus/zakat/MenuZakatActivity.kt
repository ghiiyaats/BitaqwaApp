package com.ghiiyaats.dashboardislami.menus.zakat
...
import com.ghiiyaats.dashboardislami.databinding.ActivityMenuZakatBinding
    ...
    private fun initNavMenu() {
        binding.btnZakat.setOnClickListener {
            ...
            if(binding.etAmountZakat.getNumericValue()?.toInt()!! >= 85000000) {
                ...
                Toast.makeText(
                    this, "Total Harta Belum Mencapai Nisab (85gr Emas",
                    Toast.LENGTH_LONG
                ).show()
